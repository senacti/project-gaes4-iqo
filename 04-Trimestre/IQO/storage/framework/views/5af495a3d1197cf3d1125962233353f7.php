      ...
      <div class="row g-0">
        ...
        <div class="col-lg-5 d-flex flex-column  min-vh-100">
            <div class="px-lg-3 pt-lg-2 pb-lg-1 p-1 w-100">
                <img src="<?php echo e(asset('logo/logoempresa (1).png')); ?>" class="img-fluid" width="150px">
              </div>
          <div class="px-lg-5 py-lg-4 p-4">
            <h1 class="font-weight-bold mb-4 text-center text-light" style="font-size: 50px;">
              ...
              <form method="POST" action="<?php echo e(route('login')); ?>" class="mb-5 row mt-3 g-3 needs-validation" novalidate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div>
                <div>
                    <button type="submit" class="btn btn-primary w-100" style="font-size: 20px;"><i class="fa-regular fa-right-to-bracket fa-lg"></i>
          ...
          <div class="text-center px-lg-5 pt-lg-3 pb-lg-4 p-4 w-100">
            ...
            <a href="<?php echo e(route('register')); ?>" class="text-light font-weight-bold text-decoration-none" style="font-size: 20px;"><i class="fa-solid fa-user-plus"></i> Registrate - Haz click
              aqui</a>
          </div>
      </div>
...
<?php /**PATH C:\xampp\htdocs\FINAL FINAL FINALL\IQO\resources\views/auth/login.blade.php ENDPATH**/ ?>