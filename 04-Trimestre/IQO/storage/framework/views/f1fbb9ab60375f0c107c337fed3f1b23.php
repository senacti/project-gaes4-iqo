...
<body>
    <div class="logo">
        ...
        <form class="form">
            <caption><b>REGISTRO DE PROVEEDOR</b></caption><br>
            <legend><b>Registrar Proveedor</b></legend>
            <fieldset class="datos">
                ...
                <input type="text" required placeholder="Persona Encargada">
                <input type="number" required placeholder="Numero de la persona a cargo">
                ...
                <input type="text" required placeholder="Producto que distribuye">
        ...
        <form>
            <br>
            <legend><b>Consultar Proveedor</b></legend>
            <fieldset class="datos">
                <p>
...
</html><?php /**PATH C:\xampp\IQO\IQO\resources\views/AdminRegistrarProveedor.blade.php ENDPATH**/ ?>