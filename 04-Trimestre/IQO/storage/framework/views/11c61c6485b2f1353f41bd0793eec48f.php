      ...
      <div class="row g-0">
        ...
        <div class="col-lg-5 d-flex flex-column  min-vh-100">
          ...
          <div class="text-center px-lg-5 pt-lg-3 pb-lg-4 p-4 w-100">
            ...
            <a href="<?php echo e(url('Registro')); ?>" class="text-light font-weight-bold text-decoration-none" style="font-size: 20px;"><i class="fa-solid fa-user-plus"></i> Registrate - Haz click
              aqui</a>
          </div>
      </div>
...
</html><?php /**PATH C:\xampp\htdocs\proyectoiqo\project-gaes4-iqo\04-Trimestre\IQO\resources\views/login.blade.php ENDPATH**/ ?>