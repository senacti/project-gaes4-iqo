...
<body>
    ...
    <div id="mySidenav" class="sidenav">
      ...
      <a href="ClienteReg.html"class="icon-a"><i class="fa fa-users icons"></i>Actualizar Datos</a>
      <a href="ClienteordPed.html"class="icon-a"><i class="fa fa-shopping-bag icons"></i>Consultar Ordenes de Pedido</a>
      <a href="Cliencreaorden.html"class="icon-a"><i class="fa fa-list icons"></i> Crear ordenes de Pedido</a>
      <a href="ProCamaras.html">Catalogo</a>
    ...
    <div class="wrap">
        ...
        <div class="store-wrapper">
            ...
            <section class="products-list">
                ...
                <div class="product-item" category="ordenadores">
                    <img src="images/Imagencamwifiext.png" alt="" >
                    <a href="#">Camara Wifi Exterior Ref-007 <br>4 unidades</a>
                    $90.000
                    <i class="fa fa-cart-arrow-down icons">Agregar</i>
                </div>
                <div class="product-item" category="ordenadores">
                    <img src="images/ImagencamwifiUPTZ.png" alt="" >
