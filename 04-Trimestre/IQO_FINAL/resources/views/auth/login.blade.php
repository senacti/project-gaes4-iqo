        ...
        <div class="col-lg-5 d-flex flex-column  min-vh-100">
          ...
          <div class="px-lg-5 py-lg-4 p-4">
            <h1 class="font-weight-bold mb-4 text-center text-light" style="font-size: 50px;">
              ...
              <form method="POST" action="{{ route('login') }}" class="mb-5 row mt-3 g-3 needs-validation" novalidate>
                        @csrf
          ...
          <div class="text-center px-lg-5 pt-lg-3 pb-lg-4 p-4 w-100">
            ...
            <a href="{{route('register')}}" class="text-light font-weight-bold text-decoration-none" style="font-size: 20px;"><i class="fa-solid fa-user-plus"></i> Registrate - Haz click
              aqui</a>
          </div>
      </div>
