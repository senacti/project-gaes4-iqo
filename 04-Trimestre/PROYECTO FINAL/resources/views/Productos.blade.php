...
<div class="btn-group" role="group">
    <a href="{{ url('/AdminRegistroProductos') }}" class="btn btn-primary">Volver a AdminRegistrarProductos</a>
    <a href="{{ url('/VendedorConsultarEstadoInventario') }}" class="btn btn-primary">Volver a VendedorConsultarEstadoInventario</a>
    <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalRegistrar">Añadir Producto</button>
    <a href="{{ url('/pdf') }}" class="btn btn-success" target="_blank">PDF</a>
</div>
