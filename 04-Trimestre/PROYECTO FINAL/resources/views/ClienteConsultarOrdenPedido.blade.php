...
<body>
  ...
  <nav>
    <ul>
      ...
      <li><a href="{{ url ('/ClienteActualizarDatos')}}">
          <i class="fas fa-user"></i>
          <span class="nav-item">Actualizar Datos</span>
        </a></li>
        <li><a href="{{ url ('/ClienteConsultarOrdenPedido')}}">
          <i class="fas fa-archive"></i>
          <span class="nav-item">Consultar Orden Pedido</span>
        </a></li>
      <li><a href="{{ url ('/ClienteCreaOrdenPedido')}}">
            ...
            <div class="col-md-6">
                <div class="form-box text-center">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <label for="codproductoservicio">Código de Producto o Servicio:</label>
                            <input type="text" class="form-control" id="codproductoservicio" placeholder="Ingrese el código de Producto o Servicio" pattern="\d+" required>
                        </div>
