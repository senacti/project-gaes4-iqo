        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="form-box text-center">
                    <h1>Consultar Orden de Pedido</h1>
                    <form>
                    <div class="form-group">
                            <label for="filtro">Filtrar por:</label>
                            <select class="form-control" id="filtro" required>
                                <option value="">Seleccione una opción de filtro</option>
                                <option value="urgentes">Antiguas</option>
                                <option value="mas_viejas">Intermedio</option>
            ...
            <div class="col-md-6">
                <div class="form-box text-center">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <label for="codserviciop">Código de Servicio o Producto</label>
                            <input type="text" class="form-control" id="codservicio" placeholder="Ingrese el código de servicio o producto" pattern="\d+" required>
