...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="form-box text-center">
                    <h1>Consultar Ventas Productos</h1>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="form-box text-center">
                    <h1>Consultar Ventas Servicios</h1>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                        <label for="codservicio">Código de Servicio:</label>
                            <input type="text" class="form-control" id="codservicio" placeholder="Ingrese el código de servicio" pattern="\d+" required>
                        </div>
                        <div class="form-group">
                        <label for="fechaBusqueda">Fecha Busqueda:</label>
                            <input type="date" class="form-control" id="fechaBusqueda" required>
