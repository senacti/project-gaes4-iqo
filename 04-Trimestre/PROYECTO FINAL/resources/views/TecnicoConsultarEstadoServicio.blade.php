...
<nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="card mb-4">
                    <img src="{{ asset('images/servicio1.jpg') }}" class="card-img-top" alt="Product 1">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <img src="{{ asset('images/servicio2.jpg') }}" class="card-img-top" alt="Product 2">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <img src="{{ asset('images/servicio 4.jpg') }}" class="card-img-top" alt="Product 3">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <img src="{{ asset('images/servicio6.jpg') }}" class="card-img-top" alt="Product 1">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <img src="{{ asset('images/servicio7.jpg') }}" class="card-img-top" alt="Product 1">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <img src="{{ asset('images/servicio8.jpg') }}" class="card-img-top" alt="Product 1">
                    <div class="card-body">
