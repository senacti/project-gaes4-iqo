        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="form-box text-center">
                    <h1>Consultar Estado Inventario</h1>
                    <form>
                    <div class="form-group">
                            <label for="filtro">Filtrar por:</label>
                            <select class="form-control" id="filtro" required>
                                <option value="">Seleccione una opción de filtro</option>
                                <option value="urgentes">Agotados</option>
                                <option value="mas_viejas">Casi Agotados</option>
                                <option value="recientes">Disponibles</option>
                            </select>
                        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="form-box text-center">
                    ...
                    <form>
                        <div class="form-group">
                        <p>Aquí puedes consultar los Productos de la Empresa.</p>
                        <a href=Productos class="btn btn-primary">Consultar Productos</a>
                        </div>
