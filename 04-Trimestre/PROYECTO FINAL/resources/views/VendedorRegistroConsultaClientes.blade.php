    ...
    <div class="row justify-content-center">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    <h1 class="text-center">Registro y Consulta de Clientes</h1>
                        ...
                        <form>
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                ...
                                <label class="btn btn-primary">
                                    <input type="radio" name="tipoCliente" id="clienteNatural" value="natural"> Persona Natural
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" placeholder="Digite su Correo Electronico" required>
                            </div>
                            <div class="form-group">
                                <label for="direccion">Direccion</label>
                                <input type="text" class="form-control" id="direccion" placeholder="Digite Direccion" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary d-flex align-items-center justify-content-center">
                                    <i class="fas fa-search mr-2"></i>Registrar Cliente
                                </button>
                            </div>
                        </form>
                    </div>
