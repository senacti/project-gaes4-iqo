...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="{{ url ('TecnicoConsultarEstadoServicio')}}">
                    <i class="fas fa-server"></i>
                    <span class="nav-item">Cons Estado Serv/Produc</span>
                </a></li>
            <li><a href="{{ url ('/TecnicoRegistroNovedadesServicio')}}">
                    <i class="fas fa-archive"></i>
                    <span class="nav-item">Registrar Novedades Servicio</span>
                </a></li>
            <li><a href="{{ url ('/TecnicoConsultarServiciosTecnicos')}}">
    ...
    <div class="container-sm">
        <div class="card mb-4">
            <div class="card-body">
                <h1 class="titulo">Registrar Novedades del Servicio o Producto</h1>
                <form class="formulario">
                    <div class="form-inline">
                        <div class="form-group">
                            <label for="referencia">Codigo Servicio o Producto:</label>
                            <input type="text" class="form-control" id="referencia" placeholder="Codigo de Servicio o Producto" required>
                        </div>
                    </div>
            ...
            <div class="card-body">
                <form class="formulario">
                    <div class="form-inline">
                        ...
                        <div class="form-group">
                            <label for="nombreT">Nombre Tecnico</label>
                            <input type="text" class="form-control" id="nombreT" placeholder="nombre Tecnico" required>
                        </div>
                        <div class="form-group">
                            <label for="fecha">Fecha Novedad</label>
                            <input type="date" class="form-control" id="fecha" placeholder="Fecha Novedad" required>
                        </div>
                        <div class="form-group">
                            <label for="fecha">Fecha Revision Producto</label>
                            <input type="date" class="form-control" id="fecha" placeholder="Fecha Revision Producto" required>
                        </div>
                        <div class="form-group">
                            <label for="nombreps">Nombre Producto o Servicio</label>
                            <input type="text" class="form-control" id="nombre" placeholder="Nombre Produc o Servic" required>
                        </div>
                        <div class="form-group">
                            <label for="codserviciofac">Código de Servicio o Factura</label>
                            <input type="text" class="form-control" id="codserviciofac" placeholder="Codigo Servicio/Factura" pattern="\d+" required>

                        </div>
                        <div class="form-group">
                            <label for="novedades">Informacion Novedad Servicio</label>
