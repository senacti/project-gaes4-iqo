...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <link rel="stylesheet" href="<?php echo e(asset('css/styleordenespedido.css')); ?>">
...
<body>
      ...
      <div class="logo">
        <img src="<?php echo e(asset('logo/logoIQO.png')); ?>" alt="logo">
                    <h2><center>INVENTORIES AND QUICK ORGANIZATION</center></h2>

    <div id="mySidenav" class="sidenav">
        <i class="fa fa-address-card-o icons"></i><b></b>CLIENTE</b></a>
        <a href="<?php echo e(url('/ClienteActualizarDatos')); ?>"class="icon-a"><i class="fa fa-users icons"></i> Actualizar Datos</a>
        <a href="<?php echo e(url('ClienteConsultarOrdenPedido')); ?>"class="icon-a"><i class="fa fa-shopping-bag icons"></i>Consultar Ordenes de Pedido</a>
        <a href="<?php echo e(url ('ClienteCreaOrdenPedido')); ?>"class="icon-a"><i class="fa fa-list icons"></i> Crear Ordenes de Pedido</a>
        <a href="<?php echo e(url('/CatalogoCamaras')); ?>">Catalogo</a>
        <a href=home>Volver a Roles</a>
    ...
    <div class="wrap">
        ...
        <div class="store-wrapper">
            ...
            <section class="products-list">
                ...
                <div class="product-item" category="ordenadores">
                    <img src="<?php echo e(asset('images/Imagencamwifiext.png')); ?>" alt="" >
                    <a href="#">Camara Wifi Exterior Ref-007 <br>4 unidades</a>
                    $90.000
                    <i class="fa fa-cart-arrow-down icons">Agregar</i>
                </div>
                <div class="product-item" category="ordenadores">
                    <img src="<?php echo e(asset('images/ImagencamwifiUPTZ.png')); ?>" alt="" >
...
</html><?php /**PATH C:\xampp\htdocs\PROYECTO FINAL\IQO21\resources\views/ClienteCreaOrdenPedido.blade.php ENDPATH**/ ?>