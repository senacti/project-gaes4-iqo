...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="<?php echo e(url ('/MensajeroRegistroNovedades')); ?>">
                    <i class="fas fa-archive"></i>
                    <span class="nav-item">Registrar Novedades Pedido</span>
                </a></li>
            <li><a href="<?php echo e(url ('/MensajeroRegistroOrdenesCompra')); ?>">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <h1 class="titulo">Consultar Ordenes de Compra - Proveedores</h1>
                    <form>
                        <div class="form-group">
                            <label for="orden">Selecciona Un Proveedor</label>
                            <select class="form-control" id="orden" required>
                                <option value="">Seleccione una orden de compra</option>
                                <option value="orden1">Conelec</option>
                                <option value="orden2">Alfatronic</option>
                                <option value="orden3">Electrycams</option>
                                <option value="orden3">telectronics</option>
                                <option value="orden3">Bunker</option>
                                <option value="orden3">Imposeg</option>
                                <option value="orden3">Provesi</option>
                                <option value="orden3">Total Safety</option>
                                <option value="orden3">Seguridad Industrial S.A.S</option>
                                <option value="orden3">Prosiami</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="filtro">Filtrar por:</label>
                            <select class="form-control" id="filtro" required>
                                <option value="">Seleccione una opción de filtro</option>
                                <option value="urgentes">Urgentes</option>
                                <option value="mas_viejas">Antiguas</option>
...
</html><?php /**PATH C:\xampp\htdocs\alison\IQO21\resources\views/MensajeroRegistroOrdenesCompra.blade.php ENDPATH**/ ?>