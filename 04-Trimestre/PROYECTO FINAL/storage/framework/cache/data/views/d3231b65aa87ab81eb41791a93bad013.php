...
<div class="btn-group" role="group">
    <a href="<?php echo e(url('/AdminRegistrarProveedor')); ?>" class="btn btn-primary">Volver a AdminRegistrarProveedor</a>
    <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalRegistrar">Añadir Producto</button>
    <a href="<?php echo e(url('/pdf2')); ?>" class="btn btn-success" target="_blank">PDF</a>
</div>
...
</html><?php /**PATH C:\xampp\htdocs\alison\IQO21\resources\views/Proveedor.blade.php ENDPATH**/ ?>