...
<body>
    ...
    <div class="container-sm">
        <div class="card mb-4">
            <div class="card-body">
                <h1 class="titulo">Registro tecnico</h1>
                <form class="formulario">
                    <div class="form-inline">
                        <div class="form-group">
                            <label for="referencia">Nombre Completo:</label>
                            <input type="text" class="form-control" id="referencia" placeholder="Ingrese el Nombre del Porveedor" required>
                        </div>
                        <div class="form-group">
                            <label for="email">Correo Electronico</label>
                            <input type="email" class="form-control" id="nombre" placeholder="Ingrese el correo Electronico" required>
                        </div>
                        <div class="form-group">
                            <label for="direccion">Direccion</label>
                            <input type="text" class="form-control" id="nombre" placeholder="Ingrese la direccion" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="cedula" placeholder="Digite Cedula" required>
                        </div>
                        <div class="form-group">
                                    <div class="maxl">
                                        <label class="radio inline">
                                            <input type="radio" name="gender" value="male" checked>
                                            <span> Tecnico instalacion electronica</span>
                                        </label>
                                        <label class="radio inline">
                                            <input type="radio" name="gender" value="female" checked>
                                            <span> Tecnico en Mantenimiento</span>
                                        </label>
                                        <label class="radio inline">
                                            <input type="radio" name="gender" value="female" checked>
                                            <span> Tecnico en Electricista</span>
                                        </label>
                                    </div>
                                </div>
                    </div>
    ...
    <div class="container-sm">
        <div class="card mb-4">
            <div class="card-body">
                <h1 class="titulo">Consultar Tecnico</h1>
                <form class="formulario">
                    <div class="form-group">
                        <label for="fecha">Nombre Completo</label>
                        <input type="text" class="form-control" id="fecha" placeholder="Digite Nombre Completo" required>
                    </div>
                    <div class="form-group">
                        <label for="cedula">Cedula</label>
                        <input type="text" class="form-control" id="cedula" placeholder="Digite Cedula" required>
...
</html><?php /**PATH C:\xampp\htdocs\alison\IQO21\resources\views/AdminRegistroTecnico.blade.php ENDPATH**/ ?>