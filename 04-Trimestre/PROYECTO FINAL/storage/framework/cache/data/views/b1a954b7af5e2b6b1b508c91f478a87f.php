...
<body>
    ...
    <div class="container-sm">
        <div class="card mb-4">
            <div class="card-body">
                <h1 class="titulo">Registro Ordenes de Compra</h1>
                <form class="formulario">
                    <div class="form-inline">
                        <div class="form-group">
                            <label for="nombre">Nombre Proveedor </label>
                            <input type="text" class="form-control" id="nombre" placeholder="Ingrese Nombre Proveedor" required>
                        </div>
                        <div class="form-group">
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" placeholder="Ingrese Correo Electronico" required>
                        </div>
                        <div class="form-group">
                            <label for="direccion">Direccion</label>
                            <input type="text" class="form-control" id="direccion" placeholder="Ingrese Direccion" required>
                        </div>
                        <div class="form-group">
                    ...
                    <form class="formulario">
                        <div class="form-inline">
                            <div class="form-group">
                                ...
                                <input type="num" class="form-control" id="idpedido" placeholder="Ingrese id Pedido" required>
                            </div>
                            <div class="form-group">
                                <label for="referencia">Referencia Producto</label>
                                <input type="text" class="form-control" id="referencia" placeholder="Ingrese Referencia" required>
                            </div>
                            <div class="form-group">
                                <label for="serial">Serial Producto</label>
                                <input type="text" class="form-control" id="serial" placeholder="Ingrese serial Producto" required>
                            </div>
                            <div class="form-group">
                                <label for="nombrep">Nombre Producto</label>
                                <input type="text" class="form-control" id="nombrep" placeholder="Ingrese Nombre Producto" required>
                            </div>
                            <div class="form-group">
                                <label for="marcap">Marca Producto</label>
                                <input type="text" class="form-control" id="marcap" placeholder="Ingrese Marca Producto" required>
                            </div>
                            <div class="form-group">
                                <label for="cantidad">Cantidad Productos</label>
                                <input type="num" class="form-control" id="marcap" placeholder="Ingrese Cantidad Productos" required>
                            </div>
                        </div>
    ...
    <div class="container-sm">
        <div class="card mb-4">
            <div class="card-body">
                <h1 class="titulo">Novedades Ordenes de Compra</h1>
                <form class="formulario">
                    <div class="form-group">
                        <label for="pedido">id Pedido</label>
                        <input type="num" class="form-control" id="pedido" required>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\alison\IQO21\resources\views/AdminRegistroOrdenesCompra.blade.php ENDPATH**/ ?>