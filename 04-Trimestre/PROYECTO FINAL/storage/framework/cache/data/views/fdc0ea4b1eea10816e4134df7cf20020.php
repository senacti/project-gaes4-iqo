...
<body>
    ...
    <div class="container-sm">
        <div class="card mb-4">
            <div class="card-body">
                <h1 class="titulo">Consultar Proveedor</h1>
                <form class="formulario">
                    <div class="form-group">
                        <label for="nombre">Nombre Completo</label>
                        <input type="text" class="form-control" id="nombre" placeholder="Digite Nombre Proveedor" required>
                    </div>
                    <div class="form-group">
                        <label for="cedula">Cedula o NIT</label>
                        <input type="text" class="form-control" id="cedula" placeholder="Digite Cedula o NIT" required>
    ...
    <div class="container-sm">
        <div class="card mb-4">
            <div class="card-body">
                <h1 class="titulo">Consultar Proveedor en Base de Datos</h1>
                <form class="formulario">
                
        <p>Aquí puedes consultar los Proveedores de la Empresa.</p>
        <a href=Proveedor class="btn btn-primary">Consultar Proveedor</a>
...
</html><?php /**PATH C:\xampp\htdocs\alison\IQO21\resources\views/AdminRegistrarProveedor.blade.php ENDPATH**/ ?>