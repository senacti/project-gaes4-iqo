...
<nav class="navbar navbar-expand-lg navbar navbar-light rounded sticky-top" style="background-color: #e3f2fd;">
    <div class="container-fluid">
      ...
      <div class="containersss">
        <h1>Contactanos - Sistema de Información IQO (Inventories and Quick Organization)</I></h1>
    </div>
    ...
    <section class="porfolios container">
        ...
        <div class="porfolio">
            <div class="porfolio-2">
                <h3>Contactanos - Empresa - Control y Seguridad S.A.S </h3>
                <p>
...
</html><?php /**PATH C:\xampp\htdocs\alison\IQO21\resources\views/Contacto.blade.php ENDPATH**/ ?>