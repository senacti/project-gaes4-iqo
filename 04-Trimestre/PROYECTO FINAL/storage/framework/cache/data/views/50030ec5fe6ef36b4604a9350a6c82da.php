...
<div class="logo-container">
    ...
    <h1 class="text-center mt-4 mb-4">Productos ingresados en el Inventario</h1>
...
<div class="btn-group" role="group">
    <a href="<?php echo e(url('/AdminRegistroProductos')); ?>" class="btn btn-primary">Volver a AdminRegistrarProductos</a>
    <a href="<?php echo e(url('/VendedorConsultarEstadoInventario')); ?>" class="btn btn-primary">Volver a VendedorConsultarEstadoInventario</a>
    <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalRegistrar">Añadir Producto</button>
    <a href="<?php echo e(url('/pdf')); ?>" class="btn btn-success" target="_blank">PDF</a>
</div>
...
</html><?php /**PATH C:\xampp\htdocs\alison\IQO21\resources\views/Productos.blade.php ENDPATH**/ ?>