        ...
        <section class="py-5 text-center container">
          <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
              ...
              <p>
                <a href="index (1).html" class="btn btn-primary my-2">Iniciar Sesion</a>
                <a href="Registrarse.html" class="btn btn-secondary my-2">Registrate</a>
              </p>
            </div>
          </div>
        </section>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
              <div class="col">
                <div class="card shadow-sm">
                 <img src="images/camara1.PNG" alt="">
                  <div class="card-body">
...
</html> <?php /**PATH C:\xampp\htdocs\proyectoiqo\project-gaes4-iqo\04-Trimestre\IQO\resources\views/CatalogoCamaras.blade.php ENDPATH**/ ?>