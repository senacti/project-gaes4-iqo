...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="<?php echo e(url ('/AdminConsultarProductosVendidos')); ?>">
                    <i class="fas fa-list"></i>
                    <span class="nav-item">Consultar Productos Vendidos</span>
                </a></li>
            ...
            <li><a href="<?php echo e(url ('/AdminRegistroConsultaPagos')); ?>">
                    <i class="fas fa-list-alt"></i>
                    <span class="nav-item">Registar, Consultar Pagos</span>
                </a></li>
...
</html><?php /**PATH C:\xampp\htdocs\nuevo\IQO21\resources\views/AdminConsultarClientes.blade.php ENDPATH**/ ?>